...
\begin{frame}{La conjecture centrale}
  \begin{alertblock}{Conjecture (Matt Devos, 2009)}
...
\begin{frame}{Cas $k = 4$}
  ...
  \begin{proof}[Esquisse de preuve]
    ...
    \begin{enumerate}
      ...
      \item Toute feuille $u \in T$ a $\geq 3$ voisins sur $C$, cr\'eant un cycle de longueur $\leq \lfloor c/3 \rfloor + 2$.
...
\begin{frame}{Cas $k = 4$ --- th\'eor\`eme d'existence}
  ...
  \begin{proof}[Construction de la partition]
    ...
    \medskip
    \begin{enumerate}
      \item Poser $A = C_1 \text{ ou } C_2$, $\;B = V \setminus A$.
      \item Pour tout $x \in A$ : $\dint(x) \geq 2$ et $\dext(x) \leq 2$ (4-r\'egularit\'e).
      \item Tant qu'un sommet de $B$ est non satisfait : le d\'eplacer vers $A$.
        \begin{itemize}
          \item Chaque d\'eplacement r\'eduit strictement la coupe $\Rightarrow$ terminaison.
          \item $C_2 \subset B$ reste intact : $B$ n'est jamais vid\'e.
        \end{itemize}
    \end{enumerate}
  \end{proof}
...
\begin{frame}{Conclusion}
  \begin{block}{Ce que nous avons \'etabli}
    \begin{itemize}
      ...
      \item Exp\'erimentation algorithmique : aucun nouveau résultat pour $k \geq 5$, mais validation des heuristiques sur les petits graphes.
    \end{itemize}
  \end{block}
...
\begin{frame}{Perspectives}
  \begin{enumerate}
    ...
    \'Etudier les \emph{Balanced Satisfactory Partitions} o\`u $\bigl||A| - |B|\bigr| \leq 1$ ou d'autres variantes du probl\`eme.
  \end{enumerate}
