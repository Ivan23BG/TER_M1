\ffigbox[\FBwidth]{%
\caption{\centering Graphe \(G\) avec un 4-cycle \(C\) et deux 2-sommets \(x\) et \(y\)}\label{fig:c4_plus_2_plus_2_1}
}{
    \fbox{
        \begin{tikzpicture}[scale=1, main node/.style={circle, draw, fill=blue!20, inner sep=1pt, font=\scriptsize, minimum size=5mm, text=black}]
            ...
            \node[ellipse, draw, thick, fill=blue!20,
                minimum width=1.73cm, minimum height=2.4cm] (Gnode) at (5.5,1) {\(G\)};
